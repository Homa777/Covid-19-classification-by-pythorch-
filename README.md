...
We can upload the dataset including train dataset and test dataset (https://github.com/ieee8023/covid-chestxray-dataset) and (ChexPert Dataset) in one single zip file in jupitor noteook, then extract it as folder in your notebook. By this way, you can upload whole dataset. 
